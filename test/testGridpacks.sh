...
DelphesHepMC2 /cvmfs/sft.cern.ch/lcg/releases/delphes/3.5.0-2887f/x86_64-centos7-gcc8-opt/cards/gen_card.tcl unweighted_events.root $prodBase/run/unweighted_events.hepmc
