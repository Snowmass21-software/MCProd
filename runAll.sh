...
if [[ $# < 7 ]]; then
    ...
    echo "Example: ./runAll.sh /work/jstupak/prod/MCProd/gridpacks/13TeV_B.tar.gz 1 100 $prodBase/Cards/pythia8_card.dat /cvmfs/sft.cern.ch/lcg/releases/delphes/3.5.0-2887f/x86_64-centos7-gcc8-opt/cards/FCC/FCChh.tcl $PWD/run 1"
    exit
else
    #for runGridpack.sh
    gridpack=$1
